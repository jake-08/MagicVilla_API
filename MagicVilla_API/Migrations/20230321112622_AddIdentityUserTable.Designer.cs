...
namespace MagicVilla_VillaAPI.Migrations
{
    ...
    [Migration("20230321112622_AddIdentityUserTable")]
            ...
            modelBuilder.Entity("MagicVilla_API.Models.Villa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Amenity = "Free Drinks",
                            CreatedDate = new DateTime(2023, 3, 21, 22, 26, 22, 384, DateTimeKind.Local).AddTicks(5682),
                        ...
                        new
                        {
                            Id = 2,
                            Amenity = "Free Beer",
                            CreatedDate = new DateTime(2023, 3, 21, 22, 26, 22, 384, DateTimeKind.Local).AddTicks(5747),
                            Details = "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
                        ...
                        new
                        {
                            Id = 3,
                            Amenity = "Free Snacks",
                            CreatedDate = new DateTime(2023, 3, 21, 22, 26, 22, 384, DateTimeKind.Local).AddTicks(5750),
                            Details = "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
                        ...
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 3, 21, 22, 26, 22, 384, DateTimeKind.Local).AddTicks(5753),
                            Details = "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
                        ...
                        new
                        {
                            Id = 5,
                            Amenity = "Free Drinks",
                            CreatedDate = new DateTime(2023, 3, 21, 22, 26, 22, 384, DateTimeKind.Local).AddTicks(5756),
                            Details = "Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.",
